...
template <typename NodeTy, typename EdgeTy, typename NodeData, typename EdgeData>
using DistLocalGraphPtr =
    std::unique_ptr<galois::graphs::WMDGraph<NodeTy, EdgeTy, NodeData, EdgeData, OECPolicy>>;
...
template <typename NodeData, typename EdgeData>
DistLocalSubstratePtr<NodeData, EdgeData>
gluonInitialization(std::unique_ptr<galois::graphs::DistLocalGraph<NodeData, EdgeData>>& g) {
