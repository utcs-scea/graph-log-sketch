#ifndef KATANA_LIBANALYTICS_KATANA_JACCARD_H_
#define KATANA_LIBANALYTICS_KATANA_JACCARD_H_

#include <iostream>

#include "katana/AnalyticsPlan.h"
...
public:
  ...
  JaccardPlan() : JaccardPlan(Architecture::kCPU, kUnknown) {}
  ...
  static JaccardPlan Unsorted() { return {Architecture::kCPU, kUnsorted}; }

  /// The graph's edge lists are sorted; optimize based on this.
  static JaccardPlan Sorted() { return {Architecture::kCPU, kSorted}; }
};
