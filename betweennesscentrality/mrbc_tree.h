...
#ifndef GRAPH_LOG_SKETCH_BETWEENNESSCENTRALITY_MRBC_TREE_H_
#define GRAPH_LOG_SKETCH_BETWEENNESSCENTRALITY_MRBC_TREE_H_
#include <limits>
#include <functional>
#include <utility>
...
public:
  ...
  void setDistance(uint32_t index, uint32_t newDistance) {
    // Only for iteration initialization
...
#endif // GRAPH_LOG_SKETCH_BETWEENNESSCENTRALITY_MRBC_TREE_H_
